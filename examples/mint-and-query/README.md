...
End-to-end proof that surfpool-helius works. This example:

1. Points [Metaplex UMI](https://developers.metaplex.com/umi) at the proxy (not Surfpool directly) so every RPC and WS call flows through surfpool-helius.
...
You need Surfpool and surfpool-helius running. From the repo root:
...
→ on-chain name: surfpool-helius demo
